...
\begin{framed}
  \begin{definition} Subcategory
    ...
    \end{itemize}
    with identities and composition in $\mathcal S$ as in $\mathcal C$.
  \end{definition}
\end{framed}
...
\begin{exercise}
  ...
  What happens for the other categories described in this lecture?  (Btw, in
  some of the categories there will be no solution.)  In particular, have a
  look at $\catmon$, $\catpreo$, $\catpred$, and $\catrel$.
\end{exercise}
