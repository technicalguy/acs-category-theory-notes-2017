...
\begin{remark}
    Recall the universal problem of generating a monoid $(S^*, \epsilon, \cdot)$
    ...
    \shortmid, \star)$
    \begin{equation*}
        H_{\catmon} = \catmon ( (S^*, \epsilon, \cdot), (M, \shortmid, \star) )
    \end{equation*}
    ...
    \begin{tikzcd}
        ...
        & (S^*, \epsilon, \cdot) \arrow[d, "\exists! f^\# \text{ homomorphism}"]
        \\
        {} & (M, \shortmid, \star)
    \end{tikzcd}
    \end{center}
    ...
    \begin{equation*}
        \catmon ( (S^*, \epsilon, \cdot), (M, \shortmid, \star) ) \simeq
        \catset ( S, M )
    \end{equation*}
