...
\begin{center}
\begin{tikzcd}
F \arrow[d, "h"'] \arrow[r, "f'"] & E \arrow[r, "g'"] \arrow[d, "h'"'] & D \arrow[d, "h''"'] \\
...
\begin{center}
\begin{tikzcd}
A \arrow[r, "id_A"] \arrow[d, "id_A"'] & A \arrow[d] \\
A \arrow[r, "m"'] & B
\end{tikzcd}	
\end{center}
is a pullback
...
\begin{center}
\begin{tikzcd}
P \arrow[r] \arrow[d, "p"'] & S \arrow[d, "m"] \\
A \arrow[r] & B
\end{tikzcd}
\end{center}
...
\begin{center}
\begin{tikzcd}
\{ (a,s) \mid f(a) = m(s) \}  \arrow[r] \arrow[d] & S \arrow[d, "m", tail] \\
A \arrow[r, "f"'] & B
\end{tikzcd}
\end{center}
But
...
\begin{center}
\begin{tikzcd}
f^{-1}(S) \arrow[r] \arrow[d, tail] & S \arrow[d, "m", tail] \\
A \arrow[r, "f"'] & B
\end{tikzcd}
\end{center}
...
\begin{center}
\begin{tikzcd}
A \arrow[r, "f"] \arrow[d, "id_A"] & B \arrow[d, "id_B"] \\
A \arrow[r, "f"'] & B
\end{tikzcd}
\end{center}
...
\begin{center}
\begin{tikzcd}
f^*(S) \arrow[r] \arrow[d, "f^*(m)"'] & S \arrow[d, "m", tail] \\
Y \arrow[r, "f"'] & X
\end{tikzcd}
\end{center}
\end{definition}
